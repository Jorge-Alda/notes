...
- $$\boldsymbol{U}=U_0\exp\left(\frac{i}{F_0}\begin{pmatrix}\pi^0 + \frac{\eta_8}{\sqrt{3}} & \sqrt{2} \pi^+ & \sqrt{2}K^+\\\sqrt{2}\pi^- & -\pi^0 +\frac{\eta_8}{\sqrt{3}} & \sqrt{2} K^0\\\sqrt{2}K^- & \sqrt{2}\bar{K}^0 & -\frac{2}{\sqrt{3}}\eta_8\end{pmatrix}\right)\equiv \exp\left(\frac{i}{F_0}\lambda_a \pi^a\right)$$
...
Now the Lagrangian is invariant under local chiral transformations $(\boldsymbol{g_L}, \boldsymbol{g_R})\in U(3)_L\times U(3)_R$, with 
- $$\boldsymbol{U}=U_0\exp\left(\frac{i}{F_0}\begin{pmatrix}\pi^0 + \frac{\eta_8}{\sqrt{3}}+\sqrt{\frac{2}{3}}\eta_0 & \sqrt{2} \pi^+ & \sqrt{2}K^+\\\sqrt{2}\pi^- & -\pi^0 +\frac{\eta_8}{\sqrt{3}}+\sqrt{\frac{2}{3}}\eta_0 & \sqrt{2} K^0\\\sqrt{2}K^- & \sqrt{2}\bar{K}^0 & -\frac{2}{\sqrt{3}}\eta_8+\sqrt{\frac{2}{3}}\eta_0\end{pmatrix}\right)\equiv \exp\left(\frac{i}{F_0}\lambda_a \pi^a\right)$$ $\langle \log\boldsymbol{U}\rangle = \frac{i}{F_0}\sqrt{\frac{3}{2}}\eta_0$
...
Parametrizing the expectation value of the meson matrix as $U_0 =\mathrm{diag}(e^{i\varphi_u}, e^{i\varphi_d}, e^{i\varphi_s})$, the potential is
