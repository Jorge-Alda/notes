...
We follow the steps of, but introducing the derivative coupling to quarks in addition to the anomalous couplings to gluons.
...
\end{align}$$ Agreeing with 2211.02867, and consequently reproducing the well-known QCD axion mass when plugging the correct hadronic inputs (see discusion there...)
