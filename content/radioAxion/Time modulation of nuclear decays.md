...
$$N(t) = N_0 \exp(-\Gamma(t)t) = N_0 \exp[-(\Gamma(0)+\mathring{\Gamma}(0)\theta^2(t))t]\approx N_0 \exp(-\Gamma(0)t)(1 - \mathring{\Gamma}(0)t\theta^2(t) )$$again we assume $\Delta t \ll 1/\Gamma(0)$. $$\Delta N = N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1 - \frac{\mathring{\Gamma}(0)}{\Gamma(0)}\left(\frac{t_0}{\Delta t}\theta^2(t_0) - \frac{t_0+\Delta t}{\Delta t}\theta^2(t_0+\Delta t) \right) \right]\approx N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1+\frac{\mathring{\Gamma}(0)}{\Gamma(0)}\theta^2(t_0)\right]$$  $$\langle \Delta N\rangle =  N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1+\frac{\mathring{\Gamma}(0)}{\Gamma(0)}\langle\theta^2\rangle\right]$$ $$I(t) = \frac{\mathring{\Gamma}(0)}{\Gamma(0)}[\theta^2(t)-\langle \theta^2\rangle]$$
In particular for the "deterministic" scenario $\theta(t) = \frac{\sqrt{2\rho_\mathrm{DM}}}{m_a f_a} \cos(m_a t + \varphi)$, $$\Delta N(t_0) = N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1-\frac{\mathring{\Gamma}(0)}{\Gamma(0)}\frac{2\rho_\mathrm{DM}}{m_a^2 f_a^2}\left(\frac{t_0}{\Delta t}\cos^2(m_a t_0+\varphi) - \frac{t_0+\Delta t}{\Delta t}\cos^2(m_at_0+m_a\Delta t + \varphi) \right)\right]\approx N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1+\frac{\mathring{\Gamma}(0)}{\Gamma(0)}\frac{2\rho_\mathrm{DM}}{m_a^2 f_a^2}\cos^2(m_a t_0+\varphi) \right]$$
Taking a time-average over a period long enough to smooth the axion oscillations but short enough that the number of radioactive nuclei has not changed significantly, $$\langle \Delta N(t_0)\rangle = N_0 \Gamma(0) \Delta t \exp(-\Gamma(0)t_0)\left[1+\frac{\mathring{\Gamma}(0)}{\Gamma(0)}\frac{\rho_\mathrm{DM}}{m_a^2 f_a^2}\right]$$  $$I(t_0) = \frac{\Delta N(t_0)-\langle\Delta N(t_0)\rangle}{\langle \Delta N(t_0)\rangle} = \frac{\mathring{\Gamma}(0)}{\Gamma(0)}\frac{\rho_\mathrm{DM}}{m_a^2 f_a^2}\cos(2m_at_0 + 2\varphi)$$

### Fourier

The measurements are taken at $t_n = n \Delta t$, $n=0,\ldots,N-1$ $$I_n \equiv I(t_n) = $$
## Bibliography
