...
$$a^2(t) = \frac{\Phi_\mathrm{DM}^2}{4}\sum_{j,k} \alpha_j \alpha_k \sqrt{f(v_j) f(v_k)}\Delta v \left[\cos\Big(2\pi f_C(2 + v_j + v_k)t + \phi_j + \phi_k \Big)+\cos\Big(2\pi f_C (v_j - v_k)t + \phi_j-\phi_k\Big)\right]$$ $$\langle a^2\rangle = \frac{\Phi_\mathrm{DM}^2}{4}\sum_j \alpha_j^2 f(v_j) \Delta v$$
## Bibliography
